...
export function ContactInvoices({ invoices, contactId }: ContactInvoicesProps) {
  // Calculate totals
  ...
  return (
    <div className="space-y-4">
      ...
      <div className="flex justify-end">
        <Button asChild>
          <Link href={`/sales/invoices/new?contactId=${contactId}`}>
        ...
        <Card>
          <CardContent className="py-12 text-center">
            ...
            <p className="text-muted-foreground mb-4">
              Invoices for this contact will appear here.
            </p>
            <Button asChild>
              <Link href={`/sales/invoices/new?contactId=${contactId}`}>
                <Plus className="h-4 w-4 mr-2" />
