...
export function AccountTickets({ tickets, accountId }: AccountTicketsProps) {
  ...
  return (
    <div className="space-y-4">
      ...
      <div className="flex justify-end">
        <Button asChild>
          <Link href={`/cs/tickets/new?accountId=${accountId}`}>
        ...
        <Card>
          <CardContent className="py-12 text-center">
            ...
            <p className="text-muted-foreground mb-4">
              Support tickets for this account will appear here.
            </p>
            <Button asChild>
              <Link href={`/cs/tickets/new?accountId=${accountId}`}>
                <Plus className="h-4 w-4 mr-2" />
